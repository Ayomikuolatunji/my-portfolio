        ...
        <motion.div className="about-text"
            ...
            >
             <h1 className='text-[18px] text-justify'>
              ...
              <h1 className='text-[18px] mt-4 text-justify'>
              Fast-forward to today, and I've had the privilege of working at an Agro E-commerce company, an Edutech start-up, and I have couples of great personal projects. My main focus these days is building accessible, inclusive products and digital experiences at Upstatement for a variety of clients and also helping compaines achieve their purpose digitally.
              </h1>
